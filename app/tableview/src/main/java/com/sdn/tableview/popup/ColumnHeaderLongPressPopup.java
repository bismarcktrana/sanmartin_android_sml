...
public class ColumnHeaderLongPressPopup extends PopupMenu implements PopupMenu.OnMenuItemClickListener {
    ...
    public ColumnHeaderLongPressPopup(ColumnHeaderViewHolder viewHolder, ITableView tableView) {
        ...
        this.mXPosition = mViewHolder.getAdapterPosition();//getAdapterPosition();
    ...
    private void createMenuItem() {
        ...
        this.getMenu().add(Menu.NONE, SCROLL_ROW, 4, mContext.getString(R.string.scroll_to_row_position));*/
